...
int main(){
    ...
    rep(i,0,n) if(ans.count(-A[i].second)==0 and x>0){
        ans.insert(-A[i].second);
        x--;
    }
    rep(i,0,n) if(ans.count(-B[i].second)==0 and y>0){
        ans.insert(-B[i].second);
        y--;
    }
    rep(i,0,n) if(ans.count(-C[i].second)==0 and z>0){
